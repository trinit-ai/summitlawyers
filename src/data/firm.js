...
export const ATTORNEYS = [
  ...
  },
  {
    ...
    practiceSlugs: ['matrimonial-family','estate-litigation','residential-real-estate','commercial-real-estate','criminal-municipal'],
    bio: [
      ...
      "The major portion of Mr. Vigliotti's practice is now devoted to family law matters, including divorce, post divorce, child custody, and domestic violence cases. He has represented clients in guardianship and estate litigation. He also has extensive experience in residential and commercial real estate transactions and litigation. He has represented lenders and borrowers in foreclosure and deficiency litigation and both landlords and tenants in commercial and residential litigation. He has pursued zoning matters before planning and zoning boards and related litigation. In addition, he handles municipal court matters for both defendants and victims.",
      "Mr. Vigliotti graduated from Rutgers College in 1972 with a B.A. in economics, and in 1976 received his J.D. from Widener University School of Law, where among other activities, he served as articles editor for the law review.",
    ],
    bar: [
      'New Jersey State Bar Association',
      'Union County Bar Association',
